...
import com.lily.dap.service.core.Evaluator.Coercions;
import com.lily.dap.service.core.Evaluator.Expression;
import com.lily.dap.service.core.Evaluator.ExpressionString;
import com.lily.dap.service.core.Evaluator.parser.ELParser;
import com.lily.dap.service.core.Evaluator.parser.ParseException;
import com.lily.dap.service.core.Evaluator.parser.Token;
import com.lily.dap.service.core.Evaluator.parser.TokenMgrError;
...
public class ELEvaluator
{
    ...
    throws EvaluatException
  {
    ...
    if (parsedValue instanceof String) {
      ...
      Object value = ((Expression) parsedValue).evaluate (mResolver, functions, pLogger);
      ...
      String strValue = ((ExpressionString) parsedValue).evaluate (mResolver, functions, pLogger);
    ...
    throws EvaluatException
  {
	...
	// <ILLEGAL_CHARACTER>
	throw new EvaluatException (exc.getMessage ());
      }
    }
    return ret;
  }
