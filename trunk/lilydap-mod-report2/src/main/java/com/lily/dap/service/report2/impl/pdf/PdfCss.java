 ...
 * 存放Pdf支持的Style风格
 */
public class PdfCss implements Cloneable {
	...
	public PdfCss(String fontName, short size, short style,
			short italic) {
	...
	public PdfCss clone() throws CloneNotSupportedException {
		return (PdfCss)super.clone();
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof PdfCss)) {
			return false;
		}
		PdfCss rhs = (PdfCss) object;
