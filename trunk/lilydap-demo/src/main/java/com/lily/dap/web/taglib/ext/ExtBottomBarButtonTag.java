...
/**
 * <code>ExtBottomBarButtonTag</code>
 * <p>生成Ext的Ext.grid.Toolbar的Button js代码的JSP Tag</p>
 *
 * @author 邹学模
 * @date 2008-3-20
 *
 * @jsp.tag name="extBottomBarButton"
 */
public class ExtBottomBarButtonTag extends TagSupport {
	private static final long serialVersionUID = -7964100079584892016L;
//	/**
...
//	}
	...
	public int doStartTag() throws JspException {
		...
		if (handler != null)
			buf.append(", ").append("handler: ").append(handler);
