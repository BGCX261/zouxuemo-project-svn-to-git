...
/**
 * 数据字典数据源标签
 * <lilydap:dictionaryExtSimpleStore name="enabledStore" catalog="yes_no" selectText="-是否激活-"/>
 * 执行后将生成类似于如下代码：
 * 	var enabledStore = new Ext.data.SimpleStore({
 * 		fields: ['dictCode', 'dictValue'],
 * 		data : [['', '-是否激活-'],['true', '是'],['false', '否']]
 * 	})
 * 
 * @author 邹学模
 *
 * @jsp.tag name="dictionaryExtSimpleStore"
 */
public class DictionaryExtSimpleStoreTag extends TagSupport {
	/**
	 * 
	 */
