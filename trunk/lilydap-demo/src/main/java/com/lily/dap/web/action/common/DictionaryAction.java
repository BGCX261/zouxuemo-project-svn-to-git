...
import com.lily.dap.util.EscapeUtils;
 ...
 * @author zouxuemo
 */
@Results( {@Result(name = "success", location = "/WEB-INF/page/system/dictionaryMgr.jsp")})
public class DictionaryAction extends BaseAction {
    ...
    public String listCatalog(){
		...
		List<DictClassify> classifyList = dictionaryManager.getDictClassifys();
