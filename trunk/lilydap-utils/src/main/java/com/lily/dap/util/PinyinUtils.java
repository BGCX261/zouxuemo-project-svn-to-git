...
public class PinyinUtils {
	...
	public static void main(String[] args) {
		System.out.println(getPinyinWithMark("我是中国人! I'm Chinese!", true));
		
		System.out.println(getPinyinWithMark("人参 参加 大王", false));
		
		System.out.println(getPinyinWithMark("邹学模", false));
		System.out.println(getPinyinFirstLetter("邹学模"));
	}
}