...
import com.lily.dap.tool.WarPathUtils;
 ...
 */
public class GenerateJarFileFromWarsClassesMojo extends AbstractMojo
{
 ...
 /**
  ...
  private Dependency getWarClassesDependency(Artifact artifact, File warClassesDirectory) throws OverConstrainedVersionException
  {
    ...
    dependency.setArtifactId(artifact.getArtifactId() + ".warpath");
